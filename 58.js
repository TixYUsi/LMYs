...
let userCookie = ($.isNode() ? process.env.wbtcCookie : $.getdata('wbtcCookie')) || 'PPU=UID=11033707446278&UN=luvian1111&TT=9a3e1c32aa833f906f88cd66fcd76f59&PBODY=hqPSwv1o1DU84T1Ma8Gkdh7i1yTdv_Icr7vR76tDg3IkNfK3t4UZQX6dkhrVmI0xM04-8yfa3JlDRZMaDL4WOHhk5Z0-48UBjxT6rigBE1Lh6Kh8ZnO8qfbVd2MJMl3cpqZfUTQGBvOE7URiMdGtzUi02dqSfW-4UTjBjg-e44U&VER=1&CUID=qz8dIS7ZI1YikzdHi8dz2g';
let userUA = ($.isNode() ? process.env.wbtcUA : $.getdata('wbtcUA')) || 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 WUBA/10.26.5';
let userCookieArr = []
let userList = []
